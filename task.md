...
Написать погодное веб-приложение на .NET Core, использовать можно любые библиотеки, помогающие решить поставленную задачу. В приложении должен быть интерфейс и бэкенд. Фронтенд необходимо реализовать на Blazor (Blazor Server).
...
- По дизайну никаких ограничений нет, всё на ваш вкус.
